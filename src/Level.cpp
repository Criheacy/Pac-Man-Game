...
bool LevelManager::Initialize(SDL_Renderer* mRenderer, Gizmo* mGizmo)
{
	...
	titleFont = new LFont();
	titleFont->LoadTexture(this->mRenderer, "Assets/font.png");
	...
	redTitleFont->LoadTexture(this->mRenderer, "Assets/font.png", 0xD7, 0x00, 0x00);
	...
	numberFont->LoadTexture(this->mRenderer, "Assets/font_number.png");
	...
	logoTexture->LoadFromFile(mRenderer, "Assets/logo.png");
	...
	pacManTexture->LoadFromFile(mRenderer, "Assets/pacman.png");
...
bool LevelManager::RenderStartMenu()
{
	...
	redTitleFont->RenderString("REWRITE BY C6H12O6 @ SDU. FOR RESPECT", centerX, centerY + 195 + deltaY, GROUND_SCALE);
...
bool LevelManager::RenderTutorial()
{
	...
	LFont* colorFont;
	colorFont = new LFont();
	colorFont->LoadTexture(this->mRenderer, "Assets/font.png", SHADOW_COLOR[0], SHADOW_COLOR[1], SHADOW_COLOR[2]);
	...
	colorFont = new LFont();
	colorFont->LoadTexture(this->mRenderer, "Assets/font.png", SPEEDY_COLOR[0], SPEEDY_COLOR[1], SPEEDY_COLOR[2]);
	colorFont->SetOrigin(groundOriginX, groundOriginY);
	colorFont->SetUnitSize(int(WALL_WIDTH * GROUND_SCALE), int(WALL_HEIGHT * GROUND_SCALE));
	colorFont->SetTileSize(FONT_WIDTH, FONT_HEIGHT);
	...
	colorFont = new LFont();
	colorFont->LoadTexture(this->mRenderer, "Assets/font.png", BASHFUL_COLOR[0], BASHFUL_COLOR[1], BASHFUL_COLOR[2]);
	colorFont->SetOrigin(groundOriginX, groundOriginY);
	colorFont->SetUnitSize(int(WALL_WIDTH * GROUND_SCALE), int(WALL_HEIGHT * GROUND_SCALE));
	colorFont->SetTileSize(FONT_WIDTH, FONT_HEIGHT);
	...
	colorFont = new LFont();
	colorFont->LoadTexture(this->mRenderer, "Assets/font.png", POKEY_COLOR[0], POKEY_COLOR[1], POKEY_COLOR[2]);
	colorFont->SetOrigin(groundOriginX, groundOriginY);
	colorFont->SetUnitSize(int(WALL_WIDTH * GROUND_SCALE), int(WALL_HEIGHT * GROUND_SCALE));
	colorFont->SetTileSize(FONT_WIDTH, FONT_HEIGHT);
...
bool LevelManager::RenderGame()
{
	...
	if (nowTicks - lastStageTime <= 2000)
	{
		...
		colorFont = new LFont();
		colorFont->LoadTexture(this->mRenderer, "Assets/font.png", 0xDE, 0x95, 0x00);
		colorFont->SetOrigin(groundOriginX, groundOriginY);
		colorFont->SetUnitSize(int(WALL_WIDTH * GROUND_SCALE), int(WALL_HEIGHT * GROUND_SCALE));
		colorFont->SetTileSize(FONT_WIDTH, FONT_HEIGHT);
	...
	else if (nowTicks - lastStageTime <= 3000)
	{
		...
		colorFont = new LFont();
		colorFont->LoadTexture(this->mRenderer, "Assets/font.png", 0xDE, 0x00, 0x00);
		colorFont->SetOrigin(groundOriginX, groundOriginY);
		colorFont->SetUnitSize(int(WALL_WIDTH * GROUND_SCALE), int(WALL_HEIGHT * GROUND_SCALE));
		colorFont->SetTileSize(FONT_WIDTH, FONT_HEIGHT);
...
bool LevelManager::RenderComplete()
{
	...
	colorFont = new LFont();
	colorFont->LoadTexture(this->mRenderer, "Assets/font.png", fontColor[0], fontColor[1], fontColor[2]);
	colorFont->SetOrigin(groundOriginX, groundOriginY);
	colorFont->SetUnitSize(int(WALL_WIDTH * GROUND_SCALE), int(WALL_HEIGHT * GROUND_SCALE));
	colorFont->SetTileSize(FONT_WIDTH, FONT_HEIGHT);
